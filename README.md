...
## Metrics
DeepFilterNet by default calculates STOI and SSNR for different signal to noise ratios.
Created a script to calcualte different metrics that are comparable with SEGAN.
